...
struct skill_interface {
	...
	int (*elementalanalysis) (struct map_session_data *sd, uint16 skill_lv, const struct itemlist_idx *item_list);
	int (*changematerial) (struct map_session_data *sd, const struct itemlist_idx *item_list);
